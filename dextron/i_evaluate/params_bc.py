...
cpanel["runner_name"]   = "dextron.i_evaluate.runner.MyRunner"
cpanel["number_epochs"] = 2000  # epochs
...
### Agent Parameters ###
cpanel["modelname"] = ""
cpanel["sample_type"] = "max"
cpanel["action_range"] = 1.0
cpanel["action_resolution"] = 51
...
# Sample only from successful trajectories
cpanel["database_filename"] = "./workspace/parameters/for-input/session_20201011162549_sweet_cray.csv"
...
def gen_params(cpanel):
    ...
    params["runner"]["is_store"] = cpanel["is_store"]      # Is storing?
    ...
    params["agents"]["demonstrator"]["type"] = "dextron.i_evaluate.agent_bc.Controller"
    ...
    params["agents"]["demonstrator"]["methodargs"]["modelname"] = cpanel["modelname"]
    # params["agents"]["demonstrator"]["methodargs"]["sample_type"] = cpanel["sample_type"]
    # params["agents"]["demonstrator"]["methodargs"]["action_range"] = cpanel["action_range"]
    # params["agents"]["demonstrator"]["methodargs"]["action_resolution"] = cpanel["action_resolution"]
    ##############################################
    ...
    params["explorer"]["demo"]["do_reset"] = True
    ...
    params["explorer"]["demo"]["deterministic"] = True # MUST: Takes random actions
    params["explorer"]["demo"]["n_steps"] = None # Number of steps to take a step in the environment
    params["explorer"]["demo"]["n_episodes"] = cpanel["test_win_size"]
    params["explorer"]["demo"]["win_size"] = cpanel["test_win_size"]
