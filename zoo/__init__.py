...
from digideep.environment.dmc2gym import env_creator
from digideep.zoo.hand_env.hand import grasp
from gym.envs.registration import register

register(
    id="DMCHandGrasp-v0",
    entry_point="digideep.environment.dmc2gym.wrapper:DmControlWrapper",
    kwargs={'dmcenv_creator':env_creator(grasp, task_kwargs=None, environment_kwargs=None, visualize_reward=True),
